...
public class NeuTestsCommand: ICommand {
    ...
    public virtual async Task Run(
        ...
        await new NeuTestsVoidCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test00.neu", args);

        await new NeuTestsBasicIntFuncCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test01.neu", args);

        await new NeuTestsBasicFloatFuncCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test02.neu", args);

        await new NeuArithmeticTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test03.neu", args);

        await new NeuVariableTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test04.neu", args);

        await new NeuPostfixIncrementTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test05.neu", args);

        await new NeuPostfixDecrementTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test06.neu", args);

        await new NeuPrefixIncrementTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test07.neu", args);

        await new NeuPrefixDecrementTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test08.neu", args);

        await new NeuBoolTrueTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test09.neu", args);

        await new NeuBoolFalseTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test10.neu", args);

        await new NeuSizeOfTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/test11-sizeof.neu", args);


        await new NeuFooTestCommand()
            .Run(filename: "./Tests/Neu/Interpreter/testN.neu", args);
    }
}